...
let reserve2: Reserve2 = (fromOrDestination: Date | string, to?: Date | string, destination?: string) => {
 ...
 * 只支持第二个参数为字符串的函数
 */
function mycall3<T extends unknown[],  R>(f: (p1: any, p2: string, ...args: T) => R, p1: any, p2: string, ...args: T): R {
  return f(p1, p2, ...args);
}
